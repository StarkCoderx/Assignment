...
const SearchResults = () => {
    ...
    return (
        <div className='max-w-[1280px] mx-auto flex flex-col justify-center hide-scrollbar' style={{ overflowY: 'scroll', msOverflowStyle: 'none', scrollbarWidth: 'none' }}>
            <style>
                {`
          .hide-scrollbar {
        ...
        `}
            ...
            <SearchResultNavbar />
            <SearchResultText />
            <button onClick={handleFilters} className="mb-4">
